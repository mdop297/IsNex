...
```sh
nx g @nx/js:lib libs/ts-lib
```

delete library from workspace

```sh
nx g @nx/workspace:remove ts-lib
```

### python

```sh
nx generate @nxlv/python:uv-project libs/python-common --projectType library --packageName pycommon --moduleName src
```
