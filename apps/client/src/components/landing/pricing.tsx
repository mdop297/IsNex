    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div
          ...
          style={{
            background: `
              radial-gradient(ellipse 70% 50% at 30% 100%, rgba(var(--gradient-primary), 0.12), transparent 50%),
              radial-gradient(ellipse 50% 40% at 70% 0%, rgba(var(--gradient-accent), 0.1), transparent 50%)
            `,
          }}
        />
        {/* Dot pattern */}
        <div
          ...
          style={{
            backgroundImage: `radial-gradient(rgba(var(--gradient-primary), 0.3) 1px, transparent 1px)`,
