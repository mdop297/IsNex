export const INITIAL_VALUE = {
  ...
  'fb0b001f-b63f-4767-80f5-11c88cf23089': {
    id: 'fb0b001f-b63f-4767-80f5-11c88cf23089',
    value: [
      {
        id: 'ffd9ede5-8ac6-438e-a1f4-e212c60b4c76',
        type: 'image',
        children: [
          {
            text: '',
        ...
        props: {
          nodeType: 'void',
          src: 'https://res.cloudinary.com/ench-app/image/upload/v1712088831/DALL_E_2024-02-24_17.34.35_-_A_majestic_cat_with_a_stern_intense_gaze_wearing_glasses_a_traditional_Dagestani_hat_papakha_and_a_hoodie._This_cat_has_a_thick_distinguished_b_r4fjan.webp',
          alt: 'cloudinary',
          srcSet: null,
          fit: 'contain',
          sizes: {
  ...
  '0e1d425f-e2aa-4be0-8173-63b7f3cb6b38': {
    id: '0e1d425f-e2aa-4be0-8173-63b7f3cb6b38',
    value: [
      {
        id: '38855612-a68f-4a16-a197-c2a618e9ab74',
        type: 'video',
        children: [
          {
            text: '',
        ...
        props: {
          nodeType: 'void',
          src: 'https://youtu.be/0nLIGzLOXgg?si=hvr5MrPnsJIGsBPl',
          srcSet: null,
          bgColor: null,
          sizes: {
            width: 650,
          ...
          provider: {
            type: 'youtube',
            id: '0nLIGzLOXgg',
            url: 'https://youtu.be/0nLIGzLOXgg?si=hvr5MrPnsJIGsBPl',
          },
          settings: {
            controls: false,
            loop: true,
  ...
  'f7d84014-9da0-40ba-9113-947ce01150ba': {
    id: 'f7d84014-9da0-40ba-9113-947ce01150ba',
    value: [
      {
        id: '831eaa6e-9e2b-4243-ab05-3557adf638f4',
        type: 'paragraph',
        children: [
          {
            text: '',
  ...
  '1ca9fbfe-d211-4023-8afc-3f6580440638': {
    id: '1ca9fbfe-d211-4023-8afc-3f6580440638',
    value: [
      {
        id: '7bcce6ac-f2c4-4a5c-bf8a-ff60a648b62f',
        type: 'heading-three',
        children: [
          {
            text: 'Not bad, go to list items',
          },
        ],
        props: {
          nodeType: 'block',
